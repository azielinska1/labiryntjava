...
public class Maze implements Iterable<Maze.Punkt>  {
    ...
    private void loadFromBinaryFile(String filename) {
        try (DataInputStream dis = new DataInputStream(new FileInputStream(filename))) {
            ...
            System.out.println("escape: " + header.escape);
            ...
            System.out.println("solutionOffset: " + solutionOffset);
            System.out.println("separator: " + header.separator);
            System.out.println("wall: " + header.wall);
